...
namespace Study
{
    public class RestClient
    {
        public async Task<List<Repository>> StartAsync()
        {
            ...
            //Task<string> content = client.GetStringAsync("https://api.github.com/orgs/dotnet/repos");
        ...
        public class Repository
        {
            ...
            public DateTime LastPush
            {
                get
                {
                    return DateTime.ParseExact(JsonDate, "yyyy-MM-dd",System.Globalization.CultureInfo.CurrentCulture);
                }
            }
        }
    }
